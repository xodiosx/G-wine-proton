...
do
  ...
  "arm64ec/dlls_ntdll_unix_virtual_c.patch"   # Keep – fixes virtual.c for aarch64
  "loader_preloader_c.patch"                   # Keep – Android address space fix
  ...
  # The following two are arm64ec‑specific – removed
  ...
  "test-bylaws/dlls_wow64_process_c.patch"      # Keep – needed for i386 WoW64
